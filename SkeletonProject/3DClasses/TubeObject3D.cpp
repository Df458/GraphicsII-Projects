...
TubeObject3D::TubeObject3D(float radius, float width, unsigned radialSegments, float height, BaseMaterial* mat)
	:BaseObject3D(mat),m_Radius(radius), m_Width(width), m_RadialSegments(radialSegments), m_Height(height)
{
