...
struct VertexPosNM
{
	VertexPosNM():pos(0.0f, 0.0f, 0.0f),normal(0.0f, 0.0f, 0.0f),uv(0.0f, 0.0f),tangent(0.0f, 0.0f, 0.0f),binormal(0.0f, 0.0f, 0.0f){}
	VertexPosNM(float x, float y, float z, float nx = 0, float ny = 0, float nz = 0, float ux = 0, float uy = 0, float tx = 0, float ty = 0, float tz = 0, float bx = 0, float by = 0, float bz = 0):pos(x,y,z),normal(nx,ny,nz),uv(ux,uy),tangent(tx, ty, tz),binormal(bx, by, bz){}
	VertexPosNM(const D3DXVECTOR3& v):pos(v){}
